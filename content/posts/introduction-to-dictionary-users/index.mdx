...
## Summary with some `code` in heading:
...
Upon completion of this course, students will be able to:[^2] and thene ther.
...
> This is a blockquote. There are many criteria that can be used to classify dictionaries. More text
> for the There are many criteria that can be used to classify dictionaries.
