...
graph {
  ...
  G[label="Class",shape="box",width=2];
  H[label="Property",shape="diamond"];
  I[label="Class",shape="box",width=2];

  G -- H -- I;

  D[label="Concept",shape="box",width=2];
  E[label="Relationship",shape="diamond"];
  F[label="Other Concept",shape="box",width=2];

  D -- E -- F;

  A[label="Actor",shape="box",width=2];
  B[label="created",shape="diamond"];
  C[label="Object",shape="box",width=2];
...
graph {
  ...
  A[label="Superclass",shape="box",width=2];
  B[label="has",shape="diamond"];
  C[label="Subclass",shape="box",width=2];

  A -- B -- C;

  D[label="Object",shape="box",width=2];
  E[label="has subclass",shape="diamond"];
  F[label="Artwork",shape="box",width=2];

  D -- E -- F;

  G[label="Person",shape="box",width=2];
  H[label="has subclass",shape="diamond"];
  I[label="?",shape="box",width=2];
...
graph {
  ...
  A[label="Wolf Franz Radolt",shape="box",width=2];
  B[label="is a",shape="diamond"];
  C[label="Person",shape="box",width=2];
